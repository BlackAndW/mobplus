...
Mock.mock(/\/api\/org\/tree/, 'get', orgTree);
Mock.mock(/\/api\/role/, 'get', role);
Mock.mock(/\/api\/permission\/no-pager/, 'get', permissionNoPager);
Mock.mock(/\/api\/permission/, 'get', permissions);

                ...
                <a-card :bordered="true" class="card-search card-list">
                        ...
                        <div class="r">
                            <a-button-group class="btn-grp-margin-top">
                                ...
                                <a-button
                                    ...
                                    @click="$refs.modal.add(typeList, currentApp)"
                                >新增</a-button>
                                <a-button
                                    icon="delete"
                    ...
                    >
                        ...
                        <span slot="actionSlot" slot-scope="text, record">
                            <a v-action="['cms:charge:edit']" @click="$refs.modal.edit(record, typeList, currentApp)">编辑</a>
...
export default {
    ...
    methods: {
        getTypeList () {
            return this.$http.get('/cms/charge/mtype?style=2&appId=' + this.currentApp.key).then(res => {
        ...
        loadDataList: function (params) {
            return this.$http.get(url + '?style=2&appId=' + this.currentApp.key, Object.assign(params, this.queryParam));
        },

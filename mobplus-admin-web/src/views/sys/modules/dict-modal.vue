        ...
        <a-spin :spinning="confirmLoading">
            <a-form :form="form">
                ...
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="字典编码">
                    <a-input
                        v-decorator="[ 'code', {initialValue: model.code, rules: [ { required: true, message: '请输入字典编码' }] }]"
                    />
                </a-form-item>
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="字典名称">
                    <a-input
                        v-decorator="[ 'name', {initialValue: model.name, rules: [ { required: true, message: '请输入字典名称' }] }]"
                    />
                </a-form-item>
                ...
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="数据类型">
                    <a-radio-group
                        buttonStyle="solid"
                        v-decorator="[ 'type', {initialValue: model.type}]"
                    >
                        <a-radio-button :value="0">字符串</a-radio-button>
                        <a-radio-button :value="1">数 值</a-radio-button>
                    </a-radio-group>
                </a-form-item>

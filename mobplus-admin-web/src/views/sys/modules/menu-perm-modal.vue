        ...
        <a-spin :spinning="confirmLoading">
            <a-form class="menu-perm-selector">
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="菜单标题">
                    <a-input v-model="model.title" disabled />
                </a-form-item>
                <a-form-item
                    :labelCol="labelCol"
                ...
                >
                    <template>
                        <a-checkbox
                            v-if="permission.actionsOptions.length > 0 && editData==true"
...
export default {
    ...
    methods: {
        ...
        loadDataList: function (menuId) {
            this.confirmLoading = true;
            this.$http
                .get('/sys/menu/' + menuId + '/perm')
                .then(data => {
        ...
        onSubmit: function () {
            ...
            this.confirmLoading = true;
            this.$http
                .post('/sys/menu/' + this.model.id + '/perm', selected)
                .then(data => {
